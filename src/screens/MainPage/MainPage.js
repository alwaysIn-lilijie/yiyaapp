...
export function MainPage({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{display:"flex",justifyContent:'space-between',alignItems:'center',flexDirection:'row',marginTop:theme.DpHeight(100),paddingHorizontal:theme.DpWidth(28)}}>
